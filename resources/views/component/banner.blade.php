<div class="bg-agro d-flex justify-content-center align-items-center">
    <div class="container">
        <div class="d-lg-flex justify-content-between align-items-center">
            <img src="{{ asset('storage/image/logobn.png') }}" class="my-lg-auto" width="400"
                height="49" alt="agropupuk" style="image-rendering:pixelated; image-rendering: -moz-crisp-edges;">
