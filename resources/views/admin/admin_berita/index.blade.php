...
@section('admin_berita')
    <style>
        ...
        table thead {
            height: 32px;
            border-bottom: var(--hijau) 1px solid;
        }
    ...
    <header class="mx position-relative d-flex align-items-center justify-content-between">
        <div class="page">
            <span class="list_page fs-5">{{ $title }}</span>
        </div>
    ...
    <section class="mt-2 mx-2">
        ...
        <div class="data">
            ...
            <div class="card bg-white px-3 py-2 rounded-3 border-0 shadow-sm">
                {{-- tabel yang digunakan untuk menampilkan data dari tabel beritas --}}
                <table class="table table-hover">
                    <thead>
                        <tr class="">
                            <th scope="col" class="atas nomor align-middle text-center fw-bold">No</th>
                            <th scope="col" class="atas gambar align-middle text-center fw-bold">Gambar</th>
                            <th scope="col" class="atas judul align-middle text-center fw-bold">Judul</th>
                            <th scope="col" class="atas admin align-middle text-center fw-bold">Author</th>
                            <th scope="col" class="atas aksi align-middle text-center fw-bold">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @forelse ($berita as $data)
                            <tr class="data-row">
                                ...
                                <td class="isi-data data-admin">
                                    <span class="nama_admin text-black fw-semibold text-start rounded">
                                        {{ $data->user->nama }}
                                    </span>
                                </td>
