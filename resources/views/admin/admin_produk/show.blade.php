...
@section('admin_produk_show')
    <style>
        ...
        .kotak-spek {
            ...
            /* Susun elemen-elemen di bagian atas */
            border-radius: 10px;
            box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.5);
            /* Menambahkan efek shadow hanya di bagian bawah dan kanan */
        }
        ...
        .kotak-tulisan h1 {
            ...
            font-weight: bold;
            margin-top: 0;
            /* Hilangkan margin atas untuk h1 */
            margin-bottom: 10px !important;
            /* Tambahkan margin bawah untuk h1 */
        ...
        pre {
            ...
            padding-left: 30px;
            margin-top: 0;
            /* Hilangkan margin atas untuk h4 dan pre */
            margin-bottom: 10px;
            /* Tambahkan margin bawah untuk h4 dan pre */
        }
        ...
        .kontak-off .buton {
            float: right;
            margin-right: 30px;
            /* Adjust margin to create space between button and text */
        }
        ...
        .no-data {
            ...
            font-size: 18px;
            /* Anda bisa menyesuaikan ukuran font ini sesuai kebutuhan */
            color: grey;
            /* Anda bisa menyesuaikan warna teks ini sesuai kebutuhan */
    ...
    <div class="pemersatu"
        style="background: white; margin-right:6%; margin-left:6%; margin-bottom:20px; margin-top:2px ; border-radius: 15px;">
        <div class="container mt-5 mb-5">
            <div class="row">
                <div class="col-md-4">
                    <div class="card border-0  rounded">
                        <div class="card-body">
                            <img src="{{ asset('storage/gambarproduk/' . $product->image) }}" class="rounded"
                                style="width: 100%">
                        </div>
                    </div>
                </div>
    ...
    <div class="kontak-off"> <!--tokopedia-->
        <img src="{{ asset('storage/image/tokpedlogo.jpeg') }}" style="width: 20%; margin-left:28px;"></img>
        <!--ganti img tokped-->
        <hr> <!-- batas toko-->
        ...
        @forelse($product->productStores->where('marketplace', 'Tokopedia') as $store)
            ...
            <div class="buton">
                <button type="button" class="btn btn-success"
                    onclick="window.location.href='{{ $store->store_link }}'">Kontak</button>
            </div>
    ...
    <div class="kontak-off"> <!--shopi-->
        <img src="{{ asset('storage/image/sopi.png') }}" style="width: 20%; margin-left:28px;"></img>
        <!--ganti img tokped-->
        <hr> <!-- batas toko-->
        <div class="container"></div>
    ...
    <div class="kontak-off"> <!--lazada-->
        <img src="{{ asset('storage/image/lajada.png') }}" style="width: 20%; margin-left:28px;"></img>
        <!--ganti img tokped-->
        <hr> <!-- batas toko-->
    ...
    <div class="kontak-off"> <!--blibli-->
        <img src="{{ asset('storage/image/blili.png') }}" style="width: 20%; margin-left:28px;"></img>
        <!--ganti img tokped-->
        <hr> <!-- batas toko-->
        <div class="container"></div>
