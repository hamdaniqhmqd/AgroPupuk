                        ...
                        <form action="{{ route('adminproduk.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control @error('jenis') is-invalid @enderror" name="jenis">
                                    ...
                                    <option value="phonska" {{ old('jenis') == 'phonska' ? 'selected' : '' }}>Phonska
                                    </option>
                            ...
                            <div class="form-group mb-3" id="store-inputs">
                                ...
                                @if (
                                    $errors->has('store_names.*') ||
                                        $errors->has('store_links.*') ||
                                        $errors->has('prices.*') ||
                                        $errors->has('marketplaces.*'))
                                    <div class="alert alert-danger mt-2">
                                        <ul class="mb-0">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control marketplace" name="marketplaces[]">
                                        ...
                                        <option value="Tokopedia"
                                            {{ old('marketplaces.0') == 'Tokopedia' ? 'selected' : '' }}>Tokopedia</option>
                                        <option value="BliBli" {{ old('marketplaces.0') == 'BliBli' ? 'selected' : '' }}>
                                            BliBli</option>
                                        <option value="Shopee" {{ old('marketplaces.0') == 'Shopee' ? 'selected' : '' }}>
                                            Shopee</option>
                                        <option value="Lazada" {{ old('marketplaces.0') == 'Lazada' ? 'selected' : '' }}>
                                            Lazada</option>
                                    </select>
